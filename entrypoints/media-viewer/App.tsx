...
export default function App() {
    ...
    useEffect(() => {
        ...
        if (mediaTypeParam === 'screenshot') {
            browser.storage.local.get(['screenshotData']).then((result) => {
            ...
            browser.storage.local.get(['videoData', 'videoType', 'videoFileName']).then((result) => {
                if (result.videoData) {
            ...
            // Fallback: try to get any available media
